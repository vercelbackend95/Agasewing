    ...
    <section className={cn("h-full overflow-hidden py-32", className)}>
      <div className="container mx-auto flex h-full w-full items-center justify-center px-4">
        <div className="w-full">
          <div
            className="mb-10 min-h-[150px] rounded-[24px] border border-[rgba(78,100,235,0.12)] px-5 py-4 text-center backdrop-blur-[10px] md:min-h-[190px] md:p-6 md:text-left lg:min-h-[220px] lg:px-10 lg:py-8"
            style={{
              background:
